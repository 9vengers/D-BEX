...
void writeExcel(std::string filename, excelInfo* info, std::string absPath, bool hasFunctions)
{
    ...
    */
    ...
    std::string utf_string = u8"Schema";
    ws.cell("A1").value(utf_string);
    ws.cell("A1").alignment(alignment);

    setDataSchemaSheetForm(ws, "A2", u8"Table");
    setDataSchemaSheetForm(ws, "B2", u8"Fielde");
    setDataSchemaSheetForm(ws, "C2", u8"Datatype");
    setDataSchemaSheetForm(ws, "D2", u8"null");
    setDataSchemaSheetForm(ws, "E2", u8"Default");
    setDataSchemaSheetForm(ws, "F2", u8"Collation");
    setDataSchemaSheetForm(ws, "G2", u8"AI");
    ...
    utf_string = u8"Constraint";
    ws.cell(cellName).value(utf_string);
    ws.cell(cellName).alignment(alignment);

    int indexPlusOne = index + 1;

    setDataSchemaSheetForm(ws, "A" + to_string(index), u8"Table");

    cellName = "A" + to_string(index) + ":A" + to_string(indexPlusOne);
    ws.merge_cells(cellName);
    ws.cell("A" + to_string(indexPlusOne)).border(border);

    setDataSchemaSheetForm(ws, "B" + to_string(index), u8"Constraint name");

    cellName = "B" + to_string(index) + ":B" + to_string(indexPlusOne);
    ws.merge_cells(cellName);
    ws.cell("B" + to_string(indexPlusOne)).border(border);

    setDataSchemaSheetForm(ws, "C" + to_string(index), u8"PK");
    setDataSchemaSheetForm(ws, "C" + to_string(indexPlusOne), u8"Fields");
    setDataSchemaSheetForm(ws, "D" + to_string(index), u8"UK");
    setDataSchemaSheetForm(ws, "D" + to_string(indexPlusOne), u8"Fields");
    setDataSchemaSheetForm(ws, "E" + to_string(index), u8"Check");

    cellName = "E" + to_string(index) + ":F" + to_string(index);
    ws.merge_cells(cellName);
    ws.cell("F" + to_string(index)).border(border);

    setDataSchemaSheetForm(ws, "E" + to_string(indexPlusOne), u8"Field");
    setDataSchemaSheetForm(ws, "F" + to_string(indexPlusOne), u8"Statement");
    setDataSchemaSheetForm(ws, "G" + to_string(index), u8"FK");
    setDataSchemaSheetForm(ws, "G" + to_string(indexPlusOne), u8"Field");
    setDataSchemaSheetForm(ws, "H" + to_string(index), u8"Reference");
    ...
    setDataSchemaSheetForm(ws, "H" + to_string(indexPlusOne), u8"Table");
    setDataSchemaSheetForm(ws, "I" + to_string(indexPlusOne), u8"Field");
    setDataSchemaSheetForm(ws, "J" + to_string(indexPlusOne), u8"Delete rule");
    setDataSchemaSheetForm(ws, ("K" + to_string(indexPlusOne)), u8"Change rule");
